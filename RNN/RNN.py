...
TIME_STEPS = MAX_WORD_LEN  # Можно увеличить для CTC, но зависит от модели
    ...
    while True:
        ...
        for i in range(0, len(words), batch_size):
            ...
            for j, word in enumerate(batch_words):
                ...
                input_length[j] = TIME_STEPS  # ✅ исправлено: теперь отражает выход модели
...
def build_model():
    ...
    x = Masking(mask_value=0.0)(x)  # ✅ добавлено для игнорирования пустых символов
...
def build_prediction_model(ctc_model):
    input_img = ctc_model.get_layer("image").input
